...
import telegram
from VisaRobo import TIGERS, WOLVES, dispatcher
from VisaRobo.modules.disable import DisableAbleCommandHandler
from VisaRobo.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from VisaRobo.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from VisaRobo.modules.helper_funcs.string_handling import split_quotes
from VisaRobo.modules.log_channel import loggable
from VisaRobo.modules.sql import warns_sql as sql
