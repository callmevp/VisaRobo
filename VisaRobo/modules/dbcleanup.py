...
import VisaRobo.modules.sql.global_bans_sql as gban_sql
import VisaRobo.modules.sql.users_sql as user_sql
from VisaRobo import DEV_USERS, OWNER_ID, dispatcher
