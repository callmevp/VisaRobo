...
from VisaRobo.helper_extra.aichat import add_chat, get_session, remove_chat
from VisaRobo.pyrogramee.pluginshelper import admins_only, edit_or_reply
from VisaRobo import pbot as Yone
...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("yone", "Aco")
        URL = "https://api.affiliateplus.xyz/api/chatbot?message=hi&botname=@VisaRobo&ownername=@A_viyu"
        ...
        test = test.replace("yone", "Aco")
        test = test.replace("yone", "Aco")
        URL = f"https://api.affiliateplus.xyz/api/chatbot?message={test}&botname=@VisaRobo&ownername=@A_viyu"
        try:
            r = requests.request("GET", url=URL)
        except:
            return
