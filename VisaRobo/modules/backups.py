...
import VisaRobo.modules.sql.notes_sql as sql
from VisaRobo import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from VisaRobo.__main__ import DATA_IMPORT
from VisaRobo.modules.helper_funcs.chat_status import user_admin
from VisaRobo.modules.helper_funcs.alternate import typing_action

# from VisaRobo.modules.rules import get_rules
import VisaRobo.modules.sql.rules_sql as rulessql

# from VisaRobo.modules.sql import warns_sql as warnssql
import VisaRobo.modules.sql.blacklist_sql as blacklistsql
from VisaRobo.modules.sql import disable_sql as disabledsql

# from VisaRobo.modules.sql import cust_filters_sql as filtersql
# import VisaRobo.modules.sql.welcome_sql as welcsql
import VisaRobo.modules.sql.locks_sql as locksql
from VisaRobo.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("VisaRobo{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("VisaRobo{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `VisaRobo-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("VisaRobo{}.backup".format(chat_id))  # Cleaning file
