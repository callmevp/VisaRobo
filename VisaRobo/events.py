...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import VisaRobo.events

        path = Path(f"VisaRobo/modules/{shortname}.py")
        name = "VisaRobo.modules.{}".format(shortname)
        ...
        mod.VisaRobo = VisaRobo
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["VisaRobo.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "VisaRobo/modules/*.py"
